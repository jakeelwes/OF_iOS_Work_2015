...
public:
    ...
    ofParameter<bool> bShowWireframe;
...
private:
    ...
    int prevFftBins;
    ofParameter<float> binAmount, exponent, scaleMesh, spinSpeed, spinRadius, spikeScaleFactor, radToSpike, smoosh, cutoff;
    ...
    ofParameter<bool> bDrawDebug, autoClear,fftNormalize, autoSize, shapeCircular, shapeSpiral, shapeCurve, shapeSpring, shapeSpire, shapePlane, bShowBars, shapeDisc, shapeWavyDisc, pauseMesh, complete;
